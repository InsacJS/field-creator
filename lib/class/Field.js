...
class Field {
  ...
  */
  static ID (properties = {}) {
    ...
    const DEFAULT_VALIDATE = Field.createValidate(properties.type, { min: 1 })
  ...
  */
  static STRING (length, properties = {}) {
    ...
    Field.normalize(PROPERTIES)
    const DEFAULT_VALIDATE = Field.createValidate(PROPERTIES.type)
    if (PROPERTIES.validate !== null) { PROPERTIES.validate = Object.assign(DEFAULT_VALIDATE, PROPERTIES.validate) }
    return PROPERTIES
  }
  ...
  */
  static INTEGER (properties = {}) {
    properties.type = Sequelize.INTEGER()
    Field.normalize(properties)
    const DEFAULT_VALIDATE = Field.createValidate(properties.type, { min: 0 })
    if (properties.validate !== null) { properties.validate = Object.assign(DEFAULT_VALIDATE, properties.validate) }
    return properties
  }
  ...
  * @return {Object}
  */
  static createValidate (type, custom = {}) {
    let val = {}
